...
export class Editor extends Application {
    ...
    activateListeners($html) {
        ...
        $html
            ...
            .on("input", this._backgroundColorThrottle.bind(this));
    ...
    #onSaveAvatar() {
        ...
        canvas.toBlob(
            (blob) => this.#saveImage(blob, "avatar", this.#updateAvatar.bind(this)),
            "image/webp"
        );
    }
    ...
    #onSaveToken() {
        ...
        canvas.toBlob(
            (blob) => this.#saveImage(blob, "token", this.#updateTokenImg.bind(this)),
            "image/webp"
        );
    }
    ...
    #onOpenServerFileBrowser() {
        new FilePicker({
            callback: this.#onUrlDrop.bind(this),
            allowUpload: false,
            type: "image",
        }).render(true);
    }
